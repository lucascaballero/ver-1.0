			...
			<form method="post" id="usuarios">
				<table>
					<tr>
						...
						<td>
							<input type="text" name="nombre" id="nombre" readonly="readonly" value="<?php echo $_GET['nombre']; ?>" />
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<input type="text" name="materia" id="materia" readonly="readonly" value="<?php echo $_GET['materia']; ?>" />
						</td>
					</tr>
					<tr>
						<th colspan="4" style="text-align: center;" readonly="readonly">
							Texto:
						</th>
					</tr>
					<tr>
